...
<h2>Setting Virtual Host Overrides </h2>
<p><strong><br />
</strong>
  <br>
</p>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr id="row_override_{override.id}">
    ...
    <td onMouseOver="omov('{override.id}', 1);" onMouseOut="omov('{override.id}', 0);"><a href="?L=admin.vhost.setoverride&id={override.vhost}&rm={override.id}">Delete</a></td>
    </tr>
  <tr>
    <td height="1" colspan="5" bgcolor="#CCCCCC"><img src="{themePath}/images/frame/spacer.gif" alt="Spacer" height="1" /></td>
  </tr>
