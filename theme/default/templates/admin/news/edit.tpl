...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  <tr>
    ...
    <td valign="top"><input name="title" type="text" id="title" value="{news.title}" size="50"></td>
    <td valign="top">&nbsp;</td>
    <td valign="top"><strong>Show to: </strong></td>
    <td valign="top">
	  <label><input type="checkbox" name="show[]" value="g" {ck.lvl.guests}> Guests</label> <br />
	  <label><input type="checkbox" name="show[]" value="u" {ck.lvl.users}> Users</label> <br />
	  <ZONE usersLevels enabled>
	  <LOOP usersLevels>
	    <label><input type="checkbox" name="show[]" value="{level.id}" {level.checked}> {level.title}</label> <br />
	  </LOOP usersLevels>
	  </ZONE usersLevels enabled>
	</td>
  </tr>
  ...
  <tr>
    <td colspan="5"><textarea name="body" rows="20" class="fullwidth" id="body">{news.body}</textarea></td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;</td>
  </tr>
