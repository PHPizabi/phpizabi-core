...
///////////////////////////////////////////////////////////////////////////////////////
	...
	$tpl = new template;
	$tpl -> Load("editerrorpage");
	
	if (isset($_POST["Submit"])) {
		if ($handle = fopen("theme/templates/GLOBALS/errors/{$_GET["id"]}.tpl", "w")) {
			fwrite($handle, $_POST["body"]);
			fclose($handle);
			_fnc("reload", 0, "?L=admin.templates.errorpages");
		}
	}
	
	
	@touch("theme/templates/GLOBALS/errors/{$_GET["id"]}.tpl");

	$tpl -> AssignArray(array(
		"error.pageContent" => @file_get_contents("theme/templates/GLOBALS/errors/{$_GET["id"]}.tpl"),
		"error.pageName" => $_GET["id"]
	));
	
	if (!is_writable("theme/templates/GLOBALS/errors/{$_GET["id"]}.tpl")) {
