...
///////////////////////////////////////////////////////////////////////////////////////
	...
	if (isset($_GET["arr"])) $arrayPk = @base64_decode($_GET["arr"]);
	elseif (isset($_POST["arr"])) $arrayPk = @base64_decode($_POST["arr"]);
	elseif (isset($_GET["file"])) $arrayPk = file_get_contents("system/cache/{$_GET["file"]}");
	
	$tpl -> AssignArray(array(
		"decompileResult" => var_export(unpk($arrayPk), true)
	));
