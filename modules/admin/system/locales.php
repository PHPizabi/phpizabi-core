...
///////////////////////////////////////////////////////////////////////////////////////
	...
	if (isset($_POST["Submit"])) {
		$saveList = array(
			"LOCALE_SHORT_DATE_TIME",
			"LOCALE_SHORT_DATE",
			"LOCALE_SHORT_TIME",
			"LOCALE_LONG_DATE_TIME",
			"LOCALE_LONG_DATE",
			"LOCALE_LONG_TIME",
			"LOCALE_HEADER_TIME",
			"LOCALE_HEADER_DATE_TIME",
			"LOCALE_HEADER_DATE",
			"LOCALE_MONETARY_ISO639",
			"LOCALE_MONETARY_ISO3166",
			"LOCALE_MONETARY_STRINGFORMAT",
			"LOCALE_MONETARY_USEISO:639",
			"LOCALE_MONETARY_RETURNFLAT",
			"LOCALE_SITE_LANGUAGES",
			"LOCALE_LANGUAGE_ALLOW_OVERRIDE",
			"LOCALE_SITE_DEFAULT_LANGUAGE",
			"LOCALE_LANGUAGEPACK_LOCATION",
			"LOCALE_LANGUAGEPACK_TRYDEFAULT_ON_ERROR",
			"LOCALE_LANGUAGE_CACHE_ON_LOAD_SUCCESS",
			"LOCALE_SYSTEM_TIMEZONE",
			"LOCALE_FORCE_UTF8_HEADER_OVERRIDE"
		);
