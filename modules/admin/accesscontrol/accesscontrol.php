...
///////////////////////////////////////////////////////////////////////////////////////
	...
	// BUILD THE USERS TYPES REPLACEMENT ARRAY ////////////////////////////////////
	foreach ($usersTypes as $typeId => $typeName) {
		$typesReplacementArray[] = array(
			"type.id" => $typeId,
			"type.name" => $typeName
		);
	}

	$tpl -> Loop("usersTypes", $typesReplacementArray);
